...
func FuzzMergeAdjacentRuns(f *testing.F) {
	f.Add([]byte(
		`<?xml version="1.0" encoding="UTF-8"?><p:sld xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main" xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><p:cSld><p:spTree><p:sp><p:txBody><a:p><a:r><a:t>hello </a:t></a:r><a:r><a:t>world</a:t></a:r></a:p></p:txBody></p:sp></p:spTree></p:cSld></p:sld>`,
	))
	f.Add([]byte(
		`<a:p xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><a:r><a:t>{{na</a:t></a:r><a:r><a:t>me}}</a:t></a:r></a:p>`,
	))
	f.Add([]byte("<a:p></a:p>"))
	f.Add([]byte(""))
...
func FuzzInterpolateText(f *testing.F) {
	...
	f.Fuzz(func(_ *testing.T, text, ctxKey, ctxVal string) {
		...
		_ = interpolateText(text, ctx, nil)
	})
}

...
func TestPresentationEditorRejectsUpdateForSlideWithExternalRelationships(t *testing.T) {
	// Create a fixture with a truly unsupported relationship type.
	...
	_ = writeZipFixture(path, map[string]string{
		...
		"ppt/slides/_rels/slide1.xml.rels": `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rIdUnsupported" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/oleObject" Target="../embeddings/oleObject1.bin"/></Relationships>`,
	})

...
func TestCommandShapeOps(t *testing.T) {
	...
	// 3. Update Shape
	updateReq := fmt.Sprintf(`{"api_version":1,"request_id":"r3","op":"update_shape","payload":{"slide_index":0,"shape_id":%d,"updates":{"text":"Updated"}}}`, shapeID)
	...
	// 4. Remove Shape
	removeReq := fmt.Sprintf(`{"api_version":1,"request_id":"r4","op":"remove_shape","payload":{"slide_index":0,"shape_id":%d}}`, shapeID)

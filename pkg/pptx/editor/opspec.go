...
const (
	...
	OpInsertTableRow          = "insert_table_row"
	OpRemoveTableRow          = "remove_table_row"
	OpInsertTableColumn       = "insert_table_column"
	OpRemoveTableColumn       = "remove_table_column"
	...
	OpGetSlideShowMasterShapes       = "get_slide_show_master_shapes"
	OpSetSlideShowMasterShapes       = "set_slide_show_master_shapes"
	OpSetSlideFollowMasterBackground = "set_slide_follow_master_background"
	...
	OpAddSmartArtNode                = "add_smartart_node"
	OpRemoveSmartArtNode             = "remove_smartart_node"
	OpUpdateSmartArtNode             = "update_smartart_node"
...
func supportedSlideAndMetaOps() []string {
	return []string{
		...
		OpSetSlideHidden,
		OpGetSlideShowMasterShapes,
		OpSetSlideShowMasterShapes,
		OpSetSlideFollowMasterBackground,
	}
}

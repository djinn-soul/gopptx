...
with Presentation.new(str(meta["title"])) as p:
    ...
    # Title and subtitle
    slide.add_textbox(
        Inches(0.8), Inches(0.35), Inches(6.8), Inches(0.5),
        text=str(meta["title"])
    )
    slide.add_textbox(
        Inches(0.8), Inches(0.82), Inches(6.8), Inches(0.32),
        text=str(meta["subtitle"])
    )

    # Metric cards
    add_card(
        slide, 0.8, 1.35, 1.8, 1.0,
        "Revenue", format_currency(total_revenue),
        "EEF4FB", "A9C4E2"
    )
    add_card(
        slide, 2.75, 1.35, 1.8, 1.0,
        "Orders", f"{total_orders}",
        "E8F5E9", "B8D5B8"
    )
    add_card(
        slide, 0.8, 2.55, 1.8, 1.0,
        "Avg attainment", format_percent(average_attainment),
        "FCE4D6", "E8B89C"
    )
    add_card(
        slide, 2.75, 2.55, 1.8, 1.0,
        "Top region", str(max_region["region"]),
        "FFF2CC", "E0C75C"
    )
    ...
    # Description text
    slide.add_textbox(
        Inches(0.8), Inches(4.0), Inches(8.0), Inches(0.5),
    ...
    detail.add_textbox(
        Inches(0.8), Inches(0.35), Inches(5.8), Inches(0.45),
        text="Regional Detail Table"
    )
    detail.add_textbox(
        Inches(0.8), Inches(0.82), Inches(8.4), Inches(0.3),
    ...
    detail.add_textbox(
        Inches(0.8), Inches(4.45), Inches(8.6), Inches(0.3),

...
def _build_aurora_demo() -> None:
    ...
    with Presentation.new("Theme-Aware Presentation") as prs:
        ...
        print(
            f"   Colors: Primary={aurora_theme.colors.accent1}, Secondary={aurora_theme.colors.accent2}"
        )
        print(
            f"   Fonts: Major={aurora_theme.fonts.major_font}, Minor={aurora_theme.fonts.minor_font}"
        )
...
def _build_single_theme(
    name: str, slide_title: str, body: str, points: list[str], out: str
) -> None:
...
def main() -> None:
    ...
    _build_single_theme(
        ...
        "examples/output/18-theme-ocean.pptx",
    )
    ...
    _build_single_theme(
        ...
        "examples/output/18-theme-sunset.pptx",
    )
    ...
    _build_single_theme(
        ...
        "examples/output/18-theme-forest.pptx",
    )

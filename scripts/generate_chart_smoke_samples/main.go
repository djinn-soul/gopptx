...
func main() {
	...
	samples := map[string]func() ([]byte, error){
		"family1_bar_line_area_variants.pptx": createFamily1Sample,
		"family2_bubble.pptx":                 createFamily2Sample,
		"family3_radar.pptx":                  createFamily3Sample,
		"family4_stock_combo.pptx":            createFamily4Sample,
	}

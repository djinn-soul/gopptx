...
ENTRIES: tuple[UsageEntry, ...] = (
    UsageEntry("S01", "Simple", "Hello World Deck", "Create first slide and save.", ("Create a new deck", "Add first slide", "Save PPTX output")),
    UsageEntry("S02", "Simple", "Basic Text Frame", "Add controlled text regions.", ("Add title text frame", "Place body text blocks", "Save text-frame demo")),
    UsageEntry("S03", "Simple", "Large Title Styling", "Highlight title readability.", ("Large heading text", "Strong visual hierarchy", "Readable slide structure")),
    UsageEntry("S04", "Simple", "Shapes Showcase", "Use core shape primitives.", ("Rectangle content block", "Structured layout zones", "Quick slide composition")),
    UsageEntry("S05", "Simple", "Hyperlinks Basics", "Create link-ready content.", ("Title and context text", "Link placeholder callout", "Output for review")),
    UsageEntry("S06", "Simple", "Speaker Notes", "Prepare presenter context.", ("Slide with speaker context", "Notes-ready structure", "Presentation save")),
    UsageEntry("S07", "Simple", "Slide Properties", "Tune slide-level metadata.", ("Slide title setup", "Property-oriented content", "Consistent output")),
    UsageEntry("S08", "Simple", "Background Fills", "Build visual slide base.", ("Background emphasis text", "Visual contrast block", "Ready-to-theme output")),
    UsageEntry("I01", "Intermediate", "Radar Chart", "Show category vs value structure.", ("Radar categories", "Value interpretation", "Chart-ready narrative")),
    UsageEntry("I02", "Intermediate", "Bubble Chart", "Represent multi-dimensional data.", ("Bubble chart context", "Axis interpretation", "Data story frame")),
    UsageEntry("I03", "Intermediate", "Animations", "Stage progressive reveal intent.", ("Animation narrative", "Step-by-step points", "Playback-ready slide")),
    UsageEntry("I04", "Intermediate", "Slide Duplication", "Model repeatable slide patterns.", ("Source slide concept", "Duplicate/edit workflow", "Versionable output")),
    UsageEntry("I05", "Intermediate", "Image Stamping", "Place image-centric callouts.", ("Image placement zones", "Caption placeholders", "Visual asset pass")),
    UsageEntry("I06", "Intermediate", "Presentation Properties", "Control document metadata.", ("Authoring metadata", "Title/subject flow", "Governance-friendly deck")),
    UsageEntry("I07", "Intermediate", "Section Management", "Organize multi-part decks.", ("Section introduction", "Grouping strategy", "Navigation-friendly output")),
    UsageEntry("I08", "Intermediate", "Commenting API", "Enable review workflows.", ("Reviewer context", "Comment target zone", "Collaborative output")),
    UsageEntry("C01", "Complex", "Markdown + Mermaid Deck", "Generate decks from text specs.", ("Markdown ingestion", "Diagram rendering intent", "Automated slide synthesis")),
    UsageEntry("C02", "Complex", "URL Fetch to Slides", "Convert web content into slides.", ("Web capture target", "Transformation notes", "Slide conversion output")),
    UsageEntry("C03", "Complex", "Multi Master Deck", "Work with master/layout families.", ("Master family context", "Layout variance", "Template-aware output")),
    UsageEntry("C04", "Complex", "Smart Merge Assets", "Merge decks and reuse content.", ("Source/target merge", "Asset reuse intent", "Conflict-safe output")),
    UsageEntry("C05", "Complex", "Presentation Protection", "Apply protection-oriented settings.", ("Protection scenario", "Integrity expectations", "Secure distribution output")),
    UsageEntry("C06", "Complex", "Advanced Hyperlinks", "Create internal/external navigation.", ("Cross-slide navigation", "External link intent", "Interactive deck output")),
    UsageEntry("C07", "Complex", "Export & Distribution Pipeline", "Batch-export PPTX to PNG and PDF for reporting pipelines and CI/CD artifacts.", ("Build deck", "Export PDF", "Batch PNG publish")),
    UsageEntry("C08", "Complex", "Rich Slide Composite", "Combine multiple advanced capabilities.", ("Composite layout intent", "Mixed content blocks", "Production-style output")),
)
...
def _build_c07_pipeline_slide(slide) -> None:
    cards = [
        (0.75, 1.55, 2.4, 1.12, "Build PPTX\nquarterly_report.pptx", "D9EAF7", "4A86B8"),
...
def _build_c07_targets_slide(slide) -> None:
    targets = [
        (0.8, 1.45, 2.35, 1.65, "PPTX source", "docs/assets/pptx/usage/c07-python.pptx", "DCE6F2", "5B9BD5"),
        (3.25, 1.45, 2.35, 1.65, "PDF export", "docs/assets/pdf/usage/c07-python.pdf", "E2F0D9", "70AD47"),
        (5.7, 1.45, 2.35, 1.65, "PNG batch", "docs/assets/images/usage/c07-python.png", "FCE4D6", "ED7D31"),
    ]
...
def render_level_page(level: str) -> str:
    ...
    out: list[str] = [f"# {title}", "", intro, "", "Each usage is code-first and screenshot is generated from that Python code."]
...
def main() -> None:
    ...
    (USAGE_DIR / "intermediate.md").write_text(render_level_page("Intermediate"), encoding="utf-8")
    (USAGE_DIR / "complex.md").write_text(render_level_page("Complex"), encoding="utf-8")

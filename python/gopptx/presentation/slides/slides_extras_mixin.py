...
class PresentationSlidesExtrasMixin(PresentationMixinBase):
    """Mixin providing convenience slide helpers and iteration."""

    def add_title_slide(self, title: str) -> Slide:
        """Add a title slide to the presentation."""
        prs = cast("_SlideExtrasProto", self)
        return prs.add_slide(title, layout="title_only")

    def add_bullet_slide(self, title: str, bullets: list[str]) -> Slide:
        """Add a bullet slide to the presentation."""
        prs = cast("_SlideExtrasProto", self)
        return prs.add_slide(title, layout="title_and_content", bullets=bullets)
    ...
    def add_paragraph_slide(
        ...
        *,
        ...
        prs = cast("_SlideExtrasProto", self)
        slide = prs.add_slide(title, layout=layout)
    ...
    def add_slide_from_markdown(self, markdown: str, *, layout: str = "") -> int:
        ...
        result = prs.execute(ops.OP_MARKDOWN_TO_SLIDES, payload)
    ...
    def add_slide_from_url(self, url: str, *, layout: str = "") -> int:
        ...
        result = prs.execute(ops.OP_URL_FETCH_TO_SLIDES, payload)
        prs.invalidate_cache()
    ...
    def __len__(self) -> int:
        ...
        prs = cast("_SlideExtrasProto", self)
        return prs.slide_count

    def __iter__(self) -> Iterator[Slide]:
        """Iterate over all slides."""
        prs = cast("_SlideExtrasProto", self)
        return iter(prs.slides)

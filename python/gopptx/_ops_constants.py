...
OP_ADD_CHART_USER_SHAPES = "add_chart_user_shapes"
OP_ADD_COMMENT = "add_comment"
OP_ADD_CONNECTOR = "add_connector"
OP_ADD_CONNECTORS = "add_connectors"
OP_ADD_CUSTOM_XML = "add_custom_xml"
OP_ADD_EQUATION = "add_equation"
OP_ADD_GROUP_SHAPE = "add_group_shape"
OP_ADD_IMAGE = "add_image"
OP_ADD_LAYOUT_SHAPE = "add_layout_shape"
OP_ADD_LAYOUT_TEXTBOX = "add_layout_textbox"
OP_ADD_MASTER_SHAPE = "add_master_shape"
OP_ADD_MASTER_TEXTBOX = "add_master_textbox"
OP_ADD_MERMAID_SHAPE = "add_mermaid_shape"
OP_ADD_OLE_OBJECT = "add_ole_object"
OP_ADD_ONLINE_VIDEO = "add_online_video"
...
OP_ADD_SMART_ART_NODE = "add_smartart_node"
...
OP_COPY_SLIDES_FROM = "copy_slides_from"
...
OP_EXTRACT_MEDIA = "extract_media"
OP_FIND_AND_REPLACE = "find_and_replace"
OP_FIT_SHAPE_TEXT = "fit_shape_text"
OP_FIT_SHAPE_TO_TEXT = "fit_shape_to_text"
OP_GET_AUTHORS = "get_authors"
OP_GET_CHART_DATA_SOURCE = "get_chart_data_source"
OP_GET_CHART_STATE = "get_chart_state"
OP_GET_COMMENTS = "get_comments"
OP_GET_CORE_PROPERTIES = "get_core_properties"
OP_GET_EFFECTIVE_SHAPE_STYLE = "get_effective_shape_style"
...
OP_LIST_SLIDE_MEDIA = "list_slide_media"
OP_LIST_SMART_ART = "list_smartart"
...
OP_REMOVE_SMART_ART_NODE = "remove_smartart_node"
...
OP_REORDER_SLIDE_LAYOUTS = "reorder_slide_layouts"
OP_REPAIR = "repair"
OP_RESERVE_SHAPE_IDS = "reserve_shape_ids"
OP_SAVE_FLAT_XML = "save_flat_xml"
...
OP_SET_PICTURE_FILL = "set_picture_fill"
OP_SET_PLACEHOLDER_CONTENT = "set_placeholder_content"
OP_SET_SHAPE_ADJUSTMENTS = "set_shape_adjustments"
OP_SET_SHAPE_RUNS = "set_shape_runs"
OP_SET_SLIDE_BACKGROUND = "set_slide_background"
OP_SET_SLIDE_FOLLOW_MASTER_BACKGROUND = "set_slide_follow_master_background"
...
OP_SET_SLIDE_SHOW_MASTER_SHAPES = "set_slide_show_master_shapes"
...
OP_UPDATE_CHART_CACHED_VALUES = "update_chart_cached_values"
...
OP_UPDATE_SMART_ART_NODE = "update_smartart_node"
...
SUPPORTED_OPS = (OP_ADD_ANIMATION, OP_ADD_AUDIO, OP_ADD_AUTHOR, OP_ADD_CHART, OP_ADD_CHART_USER_SHAPES, OP_ADD_COMMENT, OP_ADD_CONNECTOR, OP_ADD_CONNECTORS, OP_ADD_CUSTOM_XML, OP_ADD_EQUATION, OP_ADD_GROUP_SHAPE, OP_ADD_IMAGE, OP_ADD_LAYOUT_SHAPE, OP_ADD_LAYOUT_TEXTBOX, OP_ADD_MASTER_SHAPE, OP_ADD_MASTER_TEXTBOX, OP_ADD_MERMAID_SHAPE, OP_ADD_OLE_OBJECT, OP_ADD_ONLINE_VIDEO, OP_ADD_SECTION, OP_ADD_SHAPE, OP_ADD_SLIDE, OP_ADD_SLIDE_LAYOUT, OP_ADD_SLIDE_MASTER, OP_ADD_SMART_ART, OP_ADD_SMART_ART_NODE, OP_ADD_TABLE, OP_ADD_TABLE_COLUMN, OP_ADD_TABLE_ROW, OP_ADD_TEXTBOX, OP_ADD_TEXTBOXES, OP_ADD_VBA, OP_ADD_VIDEO, OP_APPEND_SHAPE_RUN, OP_APPLY_THEME, OP_BATCH_EXECUTE, OP_BUILD_FREEFORM, OP_BUILD_PROPOSAL_TEMPLATE, OP_BUILD_SIMPLE_TEMPLATE, OP_BUILD_STATUS_TEMPLATE, OP_BUILD_TECHNICAL_TEMPLATE, OP_BUILD_TRAINING_TEMPLATE, OP_CHANGE_SMART_ART_LAYOUT, OP_CLEAR_SHAPES, OP_CLONE_LAYOUT_MASTER_FAMILY, OP_CONVERT_TO_GRAYSCALE, OP_COPY_SLIDES_FROM, OP_DEFINE_TABLE_STYLE, OP_DELETE_SMART_ART, OP_DUPLICATE_SLIDE, OP_DUPLICATE_SLIDE_AFTER, OP_EXPORT_HTML, OP_EXPORT_PDF, OP_EXTRACT_MEDIA, OP_FIND_AND_REPLACE, OP_FIT_SHAPE_TEXT, OP_FIT_SHAPE_TO_TEXT, OP_GET_AUTHORS, OP_GET_CHART_DATA_SOURCE, OP_GET_CHART_STATE, OP_GET_COMMENTS, OP_GET_CORE_PROPERTIES, OP_GET_EFFECTIVE_SHAPE_STYLE, OP_GET_HANDOUT_MASTER, OP_GET_IMAGE_METADATA, OP_GET_LAYOUT_PLACEHOLDERS, OP_GET_LAYOUT_SHAPES, OP_GET_MASTER_PLACEHOLDERS, OP_GET_MASTER_SHAPES, OP_GET_METADATA, OP_GET_NOTES, OP_GET_SECTIONS, OP_GET_SHAPE_RUNS, OP_GET_SHAPE_TEXT_STATE, OP_GET_SLIDE_BACKGROUND, OP_GET_SLIDE_HEADER_FOOTER, OP_GET_SLIDE_LAYOUT_REF, OP_GET_SLIDE_SHOW_MASTER_SHAPES, OP_GET_SLIDE_TEXT_STATES, OP_GET_SMART_ART, OP_GET_TABLE, OP_GET_THEME_COLOR_SCHEME, OP_GET_THEME_INVENTORY, OP_GROUP_SHAPES, OP_IMPORT_LAYOUT_FROM, OP_INSERT_TABLE_COLUMN, OP_INSERT_TABLE_ROW, OP_IS_DIGITALLY_SIGNED, OP_LIST_CUSTOM_XML, OP_LIST_MASTER_LAYOUTS, OP_LIST_NOTES_PLACEHOLDERS, OP_LIST_NOTES_SHAPES, OP_LIST_PLACEHOLDERS, OP_LIST_SHAPES, OP_LIST_SLIDES, OP_LIST_SLIDE_CHARTS, OP_LIST_SLIDE_IMAGES, OP_LIST_SLIDE_LAYOUTS, OP_LIST_SLIDE_MASTERS, OP_LIST_SLIDE_MEDIA, OP_LIST_SMART_ART, OP_LIST_TABLE_STYLES, OP_MARKDOWN_TO_SLIDES, OP_MERGE_FROM_EDITOR, OP_MERGE_FROM_FILE, OP_MERGE_TABLE_CELLS, OP_MOVE_SHAPE_TO_BACK, OP_MOVE_SHAPE_TO_FRONT, OP_MOVE_SHAPE_TO_INDEX, OP_MOVE_SLIDE, OP_NOTES_SLIDE_EXISTS, OP_REBIND_SLIDE_LAYOUT, OP_REMOVE_COMMENT, OP_REMOVE_CUSTOM_XML, OP_REMOVE_SECTION, OP_REMOVE_SHAPE, OP_REMOVE_SLIDE, OP_REMOVE_SLIDE_LAYOUT, OP_REMOVE_SLIDE_MASTER, OP_REMOVE_SMART_ART_NODE, OP_REMOVE_TABLE_COLUMN, OP_REMOVE_TABLE_ROW, OP_RENAME_SECTION, OP_RENDER_TEMPLATE, OP_REORDER_SLIDE_LAYOUTS, OP_REPAIR, OP_RESERVE_SHAPE_IDS, OP_SAVE_FLAT_XML, OP_SEARCH_SHAPES, OP_SET_CORE_PROPERTIES, OP_SET_GLOBAL_THEME_PRESET, OP_SET_MARK_AS_FINAL, OP_SET_MODIFY_PASSWORD, OP_SET_NOTES, OP_SET_NOTES_SHAPE_PROPS, OP_SET_NOTES_SHAPE_TEXT, OP_SET_PICTURE_FILL, OP_SET_PLACEHOLDER_CONTENT, OP_SET_SHAPE_ADJUSTMENTS, OP_SET_SHAPE_RUNS, OP_SET_SLIDE_BACKGROUND, OP_SET_SLIDE_FOLLOW_MASTER_BACKGROUND, OP_SET_SLIDE_HEADER_FOOTER, OP_SET_SLIDE_HIDDEN, OP_SET_SLIDE_SHAPE_RUNS, OP_SET_SLIDE_SHOW_MASTER_SHAPES, OP_SET_SLIDE_SIZE, OP_SET_SLIDE_TITLE, OP_SET_SLIDE_TRANSITION, OP_SET_SMART_ART_NODES, OP_SET_SMART_ART_STYLE, OP_SET_TABLE_COLUMN_WIDTH, OP_SET_TABLE_ROW_HEIGHT, OP_SET_TABLE_STYLE, OP_SET_THEME_COLOR_SCHEME, OP_SET_THEME_FONT_SCHEME, OP_SLIDE_COUNT, OP_SPLIT_TABLE_CELL, OP_SWAP_IMAGE_BY_INDEX, OP_SWAP_IMAGE_BY_REL_ID, OP_UNGROUP_SHAPES, OP_UPDATE_CHART_CACHED_VALUES, OP_UPDATE_CHART_DATA, OP_UPDATE_CHART_DATA_BATCH, OP_UPDATE_CHART_FORMATTING, OP_UPDATE_DECK_RUN_TEXTS, OP_UPDATE_HANDOUT_MASTER, OP_UPDATE_NOTES_MASTER, OP_UPDATE_SHAPE, OP_UPDATE_SHAPE_RUN_TEXT, OP_UPDATE_SLIDE, OP_UPDATE_SLIDE_RUN_TEXTS, OP_UPDATE_SMART_ART, OP_UPDATE_SMART_ART_NODE, OP_UPDATE_TABLE_CELL, OP_UPDATE_TABLE_CELL_BORDER, OP_UPDATE_TABLE_FLAGS, OP_URL_FETCH_TO_SLIDES, OP_VALIDATE)

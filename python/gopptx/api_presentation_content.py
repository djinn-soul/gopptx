...
class PresentationCommentMixin:
...
class PresentationChartMixin:
    ...
    def add_chart(
        ...
        **kwargs: str | tuple[float, float, float, float],
        ...
        Args:
            ...
            chart_type: The type of chart (e.g., 'bar', 'pie').
            categories: List of category labels.
            values_or_series: Chart data values or series.
            **kwargs: Optional formatting and positional arguments.
                - bounds: Tuple of (x, y, width, height). Default is (0, 0, 0, 0).
                - title: Chart title. Default is "Chart".

        Returns:
            int: The created chart shape ID.
        """
        bounds = kwargs.get("bounds", (0, 0, 0, 0))
        expected_bounds_len = 4
        if len(bounds) != expected_bounds_len:
    ...
    def update_chart_data(
        ...
        try:
            self.execute(ops.OP_UPDATE_CHART_DATA, cast("dict[str, Any]", payload))
        except GopptxError as e:
            # Some charts do not expose category formulas required by the updater.
            # This is a known limitation for certain chart types. Emit a warning
            # instead of failing silently.
            warnings.warn(
                f"Chart data update failed (slide {slide_index}): {e}",
                UserWarning,
                stacklevel=2,
            )


class PresentationNotesMixin:
    ...
    def add_shape(
        ...
        **kwargs: str | ShapeProps,
        ...
        Args:
            ...
            shape_type: Predefined shape type.
            bounds: Tuple of (x, y, width, height).
            **kwargs: Extra shape properties.
                - text: Optional text to embed within the shape.
                - properties: Optional ShapeProps overrides.
        """
        x, y, w, h = bounds
...
class PresentationTableMixin:
    ...
    def add_table(
        ...
        Args:
            ...
            bounds: Tuple of (x, y, cx, cy) for table boundaries.
        """
        x, y, cx, cy = bounds
        result = self.execute(
            ops.OP_ADD_TABLE,
    ...
    def merge_table_cells(
        ...
        Args:
            ...
            cell_range: Tuple of (row1, col1, row2, col2) specifying the merge span.
        """
